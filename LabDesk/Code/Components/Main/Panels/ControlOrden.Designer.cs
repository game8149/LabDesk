...
namespace LabDesk.Code.Components.Main.Panels
{
    partial class ControlOrden
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.PanelLateral.TabIndex = 0x80;
            ...
            this.LinkAbrirPerfil.Size = new Size(0x4d, 0x10);
            this.LinkAbrirPerfil.TabIndex = 9;
            this.LinkAbrirPerfil.TabStop = true;
            this.LinkAbrirPerfil.Text = "Abrir Orden";
            this.LinkAbrirPerfil.LinkClicked += new LinkLabelLinkClickedEventHandler(this.LinkAbrirPerfil_LinkClicked);
            ...
            this.LinkNuevoPerfil.Size = new Size(0x56, 0x10);
            this.LinkNuevoPerfil.TabIndex = 4;
            this.LinkNuevoPerfil.TabStop = true;
            this.LinkNuevoPerfil.Text = "Nueva Orden";
            this.LinkNuevoPerfil.LinkClicked += new LinkLabelLinkClickedEventHandler(this.LinkNuevoPerfil_LinkClicked);
            base.AutoScaleDimensions = new SizeF(6f, 13f);
            base.AutoScaleMode = AutoScaleMode.Font;
            this.BackColor = SystemColors.Window;
            base.Controls.Add(this.PanelTrabajo);
            base.Margin = new Padding(0);
            base.Name = "ControlOrden";
