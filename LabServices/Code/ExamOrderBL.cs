...
{
    public class ExamOrderBL
    {
        private ExamOrderRepository repoExamOrder = new ExamOrderRepository();

        public void ActualizarOrden(ExamOrder orden)
        {
            repoExamOrder.Save(orden);
        }
        ...
        public void AgregarOrden(ExamOrder orden)
        {
            ...
            orden.State = ExamOrder.DocumentState.OnProgress;
