...
namespace EntityLab.Code.Hospital.Analisis.Result
{
    public class ExamResult : EntityDocumentState
    {
        ...
        public IDictionary<int, ExamResultDetailed> Items;


        public string Clasificar(Paciente pac, int idTarifa, ExamResultDetailed exdet)
        {
            ...
            switch (exdet.IdTemplateAsk)
            {
                ...
                case 1:
                    if (((tiempo.Dias > 0x1d) || (tiempo.Mes != 0)) || (tiempo.Año != 0))
                    {
                        if ((tiempo.Dias > 0x1d) && (tiempo.Año == 0))
                        {
                            if (num < 11.0)
                            {
                                builder.Append(" (Bajo)");
                ...
                case 2:
                    if (((tiempo.Dias > 10) || (tiempo.Mes != 0)) || (tiempo.Año != 0))
                    {
                        if (((tiempo.Dias > 10) && (tiempo.Mes >= 0)) && ((tiempo.Año >= 0) && (tiempo.Año < 14)))
                        {
                            if (num < 33.0)
                            {
                                builder.Append(" (Bajo)");
                ...
                case 3:
                    if ((tiempo.Año != 0) || (tiempo.Dias > 0x1d))
                    {
                        if (num < 5.0)
                        {
                            builder.Append(" (Bajo)");
