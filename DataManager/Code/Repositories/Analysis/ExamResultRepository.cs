...
{
    public class ExamResultRepository : IEntityDetailRepository<ExamResult, ExamResultDetail, int>
    {
        ...
        public int Check(ExamResult obj)
        {
        ...
        public DataTable GetTable(ExamResult obj)
        {
            throw new NotImplementedException();
        }

        public IDictionary<int, ExamResult> Index()
        {
            throw new NotImplementedException();
        }

        public IDictionary<int, ExamResult> Index(ExamResult obj)
        {
            throw new NotImplementedException();
        }

        public IDictionary<int, ExamResultDetail> IndexDetail(ExamResultDetail obj)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<ExamResult> List()
        {
            throw new NotImplementedException();
        }

        public IEnumerable<ExamResult> List(ExamResult obj)
        {
            throw new NotImplementedException();
        }

        public IEnumerable<ExamResultDetail> ListDetail(ExamResultDetail obj)
        {
            throw new NotImplementedException();
        }

        public int Remove(ExamResult obj)
        {
            throw new NotImplementedException();
        }

        public int Save(ExamResult entity)
        {
            throw new NotImplementedException();
        }
    }
